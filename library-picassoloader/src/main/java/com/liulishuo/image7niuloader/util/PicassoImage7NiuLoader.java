 ...
 */
public class PicassoImage7NiuLoader extends Image7NiuLoader<PicassoImage7NiuLoader> {
    ...
    public PicassoImage7NiuLoader(Context context, String oriUrl) {
        super(context, oriUrl);
    }

    public PicassoImage7NiuLoader(ImageView imageView, String oriUrl) {
        super(imageView, oriUrl);
    }


    public PicassoImage7NiuLoader avatar() {
        this.isAvatar = true;
        return this;
    }
    ...
    public PicassoImage7NiuLoader target(final Target target) {
        this.target = target;
        return this;
    }
    ...
    public PicassoImage7NiuLoader transform(final Transformation transformation) {
    ...
    public PicassoImage7NiuLoader fetchCallback(final PicassoLoader.FetchCallBack fetchCallback) {
    ...
    public PicassoImage7NiuLoader attachCallback(final Callback attachCallback) {
